...
public abstract class Feature<C extends IFeatureConfig> {
   ...
   public static final AbstractTreeFeature<NoFeatureConfig> SHRUB = new ShrubFeature(Blocks.JUNGLE_LOG.getDefaultState(), Blocks.OAK_LEAVES.getDefaultState());
   public static final AbstractTreeFeature<NoFeatureConfig> JUNGLE_TREE = new JungleTreeFeature(false, 4, Blocks.JUNGLE_LOG.getDefaultState(), Blocks.JUNGLE_LEAVES.getDefaultState(), true);
   ...
   public static final HugeTreesFeature<NoFeatureConfig> MESA_JUNGLE = new MegaJungleFeature(false, 10, 20, Blocks.JUNGLE_LOG.getDefaultState(), Blocks.JUNGLE_LEAVES.getDefaultState());
   ...
   public Feature(boolean p_i2013_1_) {
   ...
   protected void setBlockState(IWorld p_202278_1_, BlockPos p_202278_2_, IBlockState p_202278_3_) {
      if (this.doBlockNotify) {
         p_202278_1_.setBlockState(p_202278_2_, p_202278_3_, 3);
      } else {
         p_202278_1_.setBlockState(p_202278_2_, p_202278_3_, 2);
      }
   ...
   public static boolean isPositionInStructureExact(IWorld p_202280_0_, String p_202280_1_, BlockPos p_202280_2_) {
      return STRUCTURES.get(p_202280_1_.toLowerCase(Locale.ROOT)).isPositionInsideStructure(p_202280_0_, p_202280_2_);
   }
}
